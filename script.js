...
Each answer contains two properties text(which define answer choice) and 
...
/* startQuize() function defines starting quiz values for currentQuestionIndex 
 and score initially 0. Sets the text of next button to next and calls 
...
correct or not. If answer is correct socre will be updated
by 1. Classess gets added dynamically on the basis of 
